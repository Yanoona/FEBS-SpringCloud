...
import com.yan.febsserversystem.mapper.UserMapper;
import com.yan.febsserversystem.service.IUserRoleService;
import com.yan.febsserversystem.service.IUserService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, SystemUser> implements IUserService {
    ...
    public IPage<SystemUser> findUserDetail(SystemUser user, QueryRequest request) {
        ...
        return this.baseMapper.findUserDetailPage((org.springframework.data.domain.Page) page, user);
    }
